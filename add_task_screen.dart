...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  String? _status = 'New';
  List<Map<String, String>> _volunteers = []; // Store volunteers as maps with id and name
  ...
  void initState() {
    ...
    _fetchVolunteers(); // Fetch volunteers when the screen initializes
  }
  ...
  void _saveTask() async {
    if (_selectedVolunteerId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please select a volunteer.')),
      );
      return;
    }
        ...
        child: Column(
          children: <Widget>[
            ...
            DropdownButtonFormField<String>(
              ...
              items: _volunteers.isNotEmpty
                ...
                return DropdownMenuItem<String>(
                  value: volunteer['id'], // Use the volunteer's UID
                  child: Text(volunteer['name'] ?? 'Unknown'),
                );
              }).toList()
                  : [
                DropdownMenuItem<String>(
                    value: null, child: Text('No volunteers available'))
              ],
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['New', 'Active', 'Complete', 'Bug']
                  .map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
                  child: Text(value),
