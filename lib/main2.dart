...
class _ActivityAssignmentScreenState extends State<ActivityAssignmentScreen> {
  ...
  final TextEditingController _companyController = TextEditingController(); // New controller
  ...
  void assignActivity() async {
    if (_formKey.currentState?.validate() ?? false) {
      await sendEmail(_emailController.text, selectedActivity!, selectedVolunteer!, _companyController.text);
      Navigator.push(
        context,
  ...
  Future<void> sendEmail(String email, String activity, String volunteer, String company) async {
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode(<String, dynamic>{
          'sender': {'email': 'ryanvaseem33@gmail.com', 'name': company}, // Use company name
          'to': [
            {'email': email}
          ],
          'subject': 'Activity Assignment',
          'htmlContent': '<html><body>Dear $volunteer, you have been assigned to the following activity: $activity</body></html>',
        }),
      );
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    // Reset selected activity when changing volunteer
                    selectedActivity = null;
                  });
                },
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    // Reset selected activity when changing category
                    selectedActivity = null;
                  });
                },
